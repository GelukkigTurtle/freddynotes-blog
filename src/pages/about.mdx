...
Software Engineer, Linux enthusiast. I have worked on projects doing design, development, and implementation of background processes, Web Services, Web Applications, Android Mobile Applications, and Desktop Applications.
...
My country of origin is El Salvador but now I'm located in Heredia, Costa Rica. Looking to never stop traveling and always making a difference.
 Currently enjoying work and challenges at <XA href="https://www.windriver.com/">Wind River</XA> .
...
- Java 8 (Spring)
- Node JS
- Cucumber, Protractor, RestAssured for Test Automation
- Docker, AWS, Azure
- Play Framework
- MySQL
- AngularJS 
...
### Wind River(Aug 2020 - Present)
 - Development and Support for testing automation projects.
 - Development of integration, functional and perfomance tests for different UIs and APIs.
 - Testing using Behavior-driven development to match available uses cases.
 - Code and Test documentation in Confluence.
 - Code Review in Pull Requests.

### Intertec International(Jan 2019 - Jun 2020)
 - Development and support of internal QA automated frameworks to test different components based on microservices of the business system. 
