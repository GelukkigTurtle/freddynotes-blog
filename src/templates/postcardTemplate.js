...
import { CornerCaseHandler } from '../components/imageGrid/cornerCaseHandler.js'
  ...
  render () {
    ...
    return (
      <>
        <Helmet>
          <meta charSet='utf-8' />
          <title>{`Photo from my gallery` /* Note: not a good idea to put image id here (needs JS to render the correct id). */}</title>
          ...
          {globalState => (
            <>
              ...
              >
                ...
                >
                  <FaTimesCircle
                    style={{ right: '10px', top: '10px', color: 'black' }}
                  />
                </Link>
              </span>
